...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['uploads_csv'])){
    ...
    $result = uploadCsvAndInsert($conn, 'indirect_allocation', 'STDC_Indirect_allocat_rate', $columns);
...
$pageKey = $_GET['pageKey'] ?? 'indirect_allocation';
